...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 7](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L7)

### Methods

<a name=".assignReferencePoints"></a>
#### (static) assignReferencePoints(props, hostopt, pathopt) → \{Array.<[deep-props.extract~PropAt](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~PropAt)>}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 731](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L731)
...
Array.<[deep-props.extract~PropAt](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~PropAt)>
...
#### (static) genPropsFromDescriptorEntries(descriptorEntries, permissions, opt) → \{Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>}
...
| --- | --- | --- |
| `descriptorEntries` | [deep-props.extract~DescriptorEntries](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~DescriptorEntries) | Matrix of keys and descriptors. |
| `permissions` | [deep-props.extract~Permissions](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Permissions) | Permissions list. |
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 251](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L251)
...
Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>
...
#### (static) genProtoProp(container, permissions, opt) → \{Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 296](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L296)
...
#### (static) getMapProps(container, permissions, opt) → \{Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 401](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L401)
...
#### (static) getObjectPermissions(container) → \{[deep-props.extract~Permissions](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Permissions)}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 205](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L205)
...
[deep-props.extract~Permissions](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Permissions)
...
#### (static) getOwnProps(container, permissions, opt) → \{Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 345](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L345)
...
<a name=".getProps"></a>
#### (static) getProps(container, opt) → \{Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 639](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L639)
...
#### (static) getSetProps(container, permissions, opt) → \{Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 455](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L455)
...
#### (static) getSpecialProps(container, permissions, opt) → \{Array.<[deep-props.extract~Prop](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Prop)>}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 589](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L589)
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 183](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L183)
...
#### (static) mergeOptions(opt) → \{[deep-props.extract~Options](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Options)}
...
| Name | Type | Description |
| --- | --- | --- |
| `opt` | [deep-props.extract~Options](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Options) | Options passed to the module. |

Source:

*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 890](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L890)
...
[deep-props.extract~Options](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Options)
...
<a name=".search"></a>
#### (generator, static) search(host, opt) → \{[deep-props.extract~PropAt](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~PropAt)}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 803](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L803)
...
[deep-props.extract~PropAt](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~PropAt)
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 11](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L11)
...
| `propsCustomizer` | [deep-props.extract~PropsCustomizer](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~PropsCustomizer) | \<optional> |  | Function used for custom extraction of PropEntries from a Target. |

Source:

*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 126](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L126)
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 52](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L52)
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 73](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L73)
...
| `parentIsSealed` | boolean | \<optional> | Sealed status of the parent object. |
| `parentIsExtensible` | boolean | \<optional> | Extensible status of the parent object. |
| `ref` | [deep-props.extract~Ref](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~Ref) | \<optional> | If the value strictly equals a previously discovered Container, the path and Host (if applicable) of that Container will be provided. |

Source:

*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 98](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L98)
...
#### PropsCustomizer(container) → \{[deep-props.extract~DescriptorEntries](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~DescriptorEntries)}
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 31](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L31)
...
[deep-props.extract~DescriptorEntries](https://github.com/jpcx/deep-props.extract/blob/0.1.1/docs/global.md#~DescriptorEntries)
...
*   [deep-props.extract/index.js](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js), [line 61](https://github.com/jpcx/deep-props.extract/blob/0.1.1/index.js#L61)
